...
export default function Testimonial5() {
    return (
        <>
            <section className="testimonial-section bg_op_7" style={{ backgroundImage: 'url(assets/images/map-frame-2.png)' }}>
                {/*-============spacing==========-*/}
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-12">
                            <div className="section_title type_one pd_left_20">
                            ...
                            {/*-============spacing==========-*/}
                            <div className="testimonial_carousel  position-relative position_one nav_false dot_true dot_center">
                                <Swiper {...swiperOptions} className="theme_carousel ">
                                    <SwiperSlide className="testimonial_box type_two type_three">
                        ...
                        <div className="col-lg-6 col-md-12 pd_left_60">
                            <div className="image_box_only  type_six">
