...
export default function ServiceStyle3() {
    ...
    return (
        <>
            <Layout breadcrumbTitle="Services Style 3">
                {/*-service*/}
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    <div className="service_box type_three hover_1_get">
                                        <Link href="/service" className="img_bx">
                                            <div className="image trans hover_1">
                                                <img src="/assets/images/service/service-5-min.jpg" className="img-fluid" alt="service" />
                                                <div className="oh ho_1" />
                                                <div className="oh ho_2" />
                                                <div className="oh ho_3" />
                                                <div className="oh ho_4" />
                                            ...
                                            <div className="content_box_in trans">
                                                ...
                                                <h4 className="title_24 trans">
                                                    <Link href="/service">Car
                                                        Insurance</Link></h4>
                                                <p className="trans">
                                                    Pleasant experience one has to consider the safety factor equally well.</p>
                                                <Link href="/service" className="rd_more">Read More<i className="fi-rr-arrow-small-right" /></Link>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="service_box type_three hover_1_get">
                                        ...
                                        <div className="content_box trans">
                                            <div className="content_box_in trans">
                                                ...
                                                <h4 className="title_24 trans">
                                                    <Link href="/service">
                                                        Marriage insurance</Link></h4>
                                                <p className="trans">
                                                    We cover you for wedding cancel, material damage to the property</p>
                                                <Link href="/service" className="rd_more">Read More<i className="fi-rr-arrow-small-right" /></Link>
                                            </div>
                                        </div>
                                    </div>
