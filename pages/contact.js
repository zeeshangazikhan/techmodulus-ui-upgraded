                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12">
                                <div className="contact_box_content">
                                    ...
                                    <div className="contact-infor">
                                        ...
                                        <Link href="mailto:support@gmail.com">info@ciencechip.com
                                        </Link>
                                        {/* <Link href="mailto:admin@ciencechip.com">admin@ciencechip.com</Link> */}
                                    </div>
                                </div>
                                {/*-============spacing==========-*/}
                                <div className="pd_bottom_30" />
                            ...
                            {/* <div className="col-lg-4 col-md-6 col-sm-12">
                                <div className="contact_box_content">
                                    ...
                                    <div className="contact-infor">
                                        ...
                                        <Link href="tel:+918329042459">+91 8329042459
