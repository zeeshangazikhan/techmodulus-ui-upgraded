                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="platform-content">
                                        ...
                                        <h2 className="platform-title">CienceChip Application Archiving</h2>
                        ...
                        <div className="container">
                            <div className="solution-wrapper">
                                ...
                                <div className="solution-content">
                                    ...
                                    <p>CienceChip Application Archiving provides a comprehensive solution to manage data growth while ensuring universal access to historical data, meeting compliance requirements, and preparing your data for AI initiatives.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div className="mc-engine">
                                    ...
                                    <div className="mc-engine-inner">
                                        ...
                                        <div className="mc-engine-text">
                                            <h4>CienceChip Archiving Engine</h4>
