                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="platform-content">
                                        ...
                                        <h2 className="platform-title">CienceChip Enterprise Archiving</h2>
                        ...
                        <div className="container">
                            <div className="solution-wrapper">
                                ...
                                <div className="solution-content">
                                    <p>CienceChip Enterprise Archiving is a complete suite of archiving applications including Application Retirement, Database Archiving, Email Archiving and File Archiving to manage enterprise data growth.</p>
